            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {rankings.length === 0 ? (
                      <TableRow>
                          <TableCell colSpan={5} className="text-center py-6 text-muted-foreground">No hay datos disponibles.</TableCell>
                      </TableRow>
                  ) : (
                    rankings.map((club) => (
                                            ...
                                            <TableCell className="text-sm">
                                                {item.evaluationType === 'inspection' && item.details ? (
                                                    ...
                                                    <div className="flex gap-4 text-xs text-slate-600">
                                                        {item.creativityScore !== undefined && <span className="bg-slate-100 px-2 py-1 rounded">Creatividad: <b>{item.creativityScore}</b></span>}
                                                        {item.executionScore !== undefined && <span className="bg-slate-100 px-2 py-1 rounded">Ejecución: <b>{item.executionScore}</b></span>}
                                                        {item.presentationScore !== undefined && <span className="bg-slate-100 px-2 py-1 rounded">Presentación: <b>{item.presentationScore}</b></span>}
                                                    </div>
                                                )}
